...
onready var play3 = $VBoxContainer/HBoxContainer/VBoxContainer2/Play3
...
func _ready():
	...
	play3.connect("pressed",self,"_on_play3_pressed")
...
func _on_play3_pressed():
	get_tree().change_scene("res://scenes/testRotation.tscn")
